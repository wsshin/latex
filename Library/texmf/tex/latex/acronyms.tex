...
\DeclareAcronym{salt}{
	short = SALT,
    long = steady-state \emph{ab initio} laser theory
}
\DeclareAcronym{nim}{
	short = NIM,
    long = negative index material
}
\DeclareAcronym{enz}{
	short = ENZ,
    long = epsilon-near-zero
}
\DeclareAcronym{spp}{
	short = SPP,
...
\DeclareAcronym{rcwa}{
	short = RCWA,
	long = rigorous coupled-wave analysis
}
\DeclareAcronym{dtn}{
	short = DtN,
	long = Dirichlet-to-Neumann
}
...
\DeclareAcronym{hpd}{
	short = HPD,
	long = Hermitian positive-definite
}
...
\DeclareAcronym{ucla}{
	short = UCLA,
	long = {University of California, Los Angeles}
}
\DeclareAcronym{msr}{
	short = MSR,
...
\DeclareAcronym{cmda}{
	short = CMDA,
	long = Computational Modeling and Data Analytics
}
\DeclareAcronym{ciera}{
    short = CIERA,
    long = Center for Interdisciplinary Exploration and Research in Astrophysics
}
\DeclareAcronym{reu}{
    short = REU,
    long = Research Experience for Undergraduates
}
